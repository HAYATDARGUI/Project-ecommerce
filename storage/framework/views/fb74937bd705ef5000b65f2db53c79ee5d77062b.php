            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>New Orders
                            <a href="<?php echo e(url('order-history')); ?>" class="btn btn-primary float-end">Order History</a>
                        </h4>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\E-commerce-Project-main\resources\views/Admin/orders/index.blade.php ENDPATH**/ ?>